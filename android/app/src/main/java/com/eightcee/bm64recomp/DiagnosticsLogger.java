...
public final class DiagnosticsLogger {
    ...
    private static final String TAG = "BM64Recomp";
    private static final String PREFS = "bm64_diagnostics";
            ...
            try {
                ...
                try {
                    Process lc = new ProcessBuilder()
                            ...
                            .start();
                    s.logcat = lc;
                    Thread reader = new Thread(() -> drainLogcat(s, lc), "bm64-diag-logcat");
    ...
    private void writeHeader(Context appCtx, Session s, String motivo) throws IOException {
        ...
        b.append("================================================================\n");
        b.append("Bomberman 64: Recompiled — LOG DE DIAGNÓSTICO\n");
