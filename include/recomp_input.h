...
namespace recomp {
    ...
    #define DEFINE_N64_BUTTON_INPUTS() \
        DEFINE_INPUT(A, 0x8000, "Place Bomb") \
        DEFINE_INPUT(B, 0x4000, "Lift Bomb/Talk") \
        DEFINE_INPUT(Z, 0x2000, "Detonate Bomb") \
        DEFINE_INPUT(R, 0x0010, "Stop Bomb") \
        DEFINE_INPUT(START, 0x1000, "Pause") \
        DEFINE_INPUT(C_UP, 0x0008, "Zoom In") \
        DEFINE_INPUT(C_LEFT, 0x0002, "Camera Left") \
        DEFINE_INPUT(C_DOWN, 0x0004, "Zoom Out") \
